...
RPG.Assets.GAME_TEXT = {
    ...
    events: {
        ...
        phase6BlacksmithMorning: [
            "朝になった。",
            "コンコン、と客室のドアがノックされる。",
            "カイン「おはよう。おかげでよく眠れたよ。」",
            "娘「カインさん…東の国の鍛冶屋さんがいらっしゃってます」",
            "カイン「鍛冶屋…？」",
            "娘「王都へ復興用の資材を運ぶ途中だそうです。」",
            "カイン「わかった。今行く。」"
        ],
        phase6BlacksmithTalk: [
            "広間の奥にあるテーブルへ、旅装の男が座っていた。",
            "白い髪のそばには大きな鞄が置かれ、壁際には布をかけた荷物が積まれている。",
            "東の鍛冶屋「先に言っておくが、剣の仕事は受けねえぞ。砥石も油も、王都へ運ぶ大事な物資だからな」",
            "カイン「挨拶だけさせてくれよ。あんた、王都に行くんだろ？ 俺は王都から来たんだ」",
            "カインは鍛冶屋の手を取り、丁寧に握手をした。",
            "カイン「…復興の手伝い、ありがとう。よろしく頼むよ」",
            "鍛冶屋「……」",
            "鍛冶屋の視線が、カインの腰にある剣へ落ちる。",
            "東の鍛冶屋「ちょっと、その剣を見せてみろ」",
            "カイン「これか？」",
            "カインは剣を鞘ごと差し出した。",
            "鍛冶屋は剣を受け取り、鞘からわずかに抜く。",
            "刃を見た途端、その目つきが変わった。",
            "東の鍛冶屋「これは……！？こんな剣、どこで手に入れた？」",
            "カイン「……王家から賜った」",
            "カインは声を抑えて答えた。",
            "東の鍛冶屋「……そうか」",
            "鍛冶屋はしばらく剣を見つめていた。",
            "やがて、足元の鞄を開く。",
            "中には、砥石や油、布や細かな道具が隙間なく詰められていた。",
            "東の鍛冶屋「貸せ。手入れしてやる」",
            "カイン「いいのか？ 俺はこっちで使える銀貨を持ってないんだ」",
            "東の鍛冶屋「……野暮なことを言うな。これでも、見る目はあるつもりだ」",
            "剣を研いでくれた！",
            "カインの剣のレベルが上がった！",
            "攻撃力＋2",
            "カイン「ありがとう。また会う機会があったら、ちゃんと礼をさせてくれ」",
            "カインは財布を開き、中に残っていた王国の銅貨を取り出した。",
            "カイン「貨幣としての価値はないが、金属としてなら役に立つかもしれない。」",
            "カインは、残っていた王国銅貨を鍛冶屋へ渡した。",
            "鍛冶屋「…すぐに、とはいかないだろうが、王国通貨はきっと価値を取り戻すぞ。いいのか？」",
            "その言葉にカインは笑った。",
            "カイン「俺が後悔する日が早く来るといいな！」",
            "鍛冶屋「……そうなるよう、頑張ってくるよ」",
            "鍛冶屋は荷物をまとめ、宿屋を出て行った。",
            "カイン（さすがに、アーサーによろしくとは言えなかったな）"
        ],
