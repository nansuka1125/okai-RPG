...
RPG.Assets.CONFIG = {
    ...
    ITEM_DESC: {
        ...
        highHerbJam: "味は想像がつく。使うと準備状態になり、次以降の戦闘で体力が半分以下になった時、一度だけ全回復する。",
        ...
        secretLetter: "俺への手紙。読もう。",
        secretLetterBody: "『カインさんが森で活躍している姿を、いつも素敵だなと思っています。\n今度、よかったら一緒に森でピクニックしませんか？』",
...
RPG.Assets.GAME_TEXT = {
    ...
    events: {
        ...
        innRepairHelpStart: [
            ...
            "カイン「お！」",
            "店主「ここからは俺一人でもなんとかなる」",
            "カイン「よかったら、手伝わせてくれ。金もないのに泊めてもらってるんだ。少しでも礼がしたい」",
            "店主「……そうか。じゃあ、手伝ってもらうかな」",
            "カインが木材に手を伸ばすと、店主が止めた。",
            "店主「その前に、油がいるな」",
            "カイン「油？」",
            "店主「木材を長持ちさせる油だ。娘にテカテカ油をもらってきてくれ」",
            "カイン「テカテカ油だな。分かった！」"
        ],
        // 娘の油イベントは中間に三択UIを挟むため、intro/outro の2配列に分ける
        // （既存の琥珀樹の根イベントと同じ構造 - inspectAmberRoot → showXChoices）。
        // 本文は確定文のまま、分割は技術的な都合のみで新規台詞は含まない。
        innRepairDaughterOilsIntro: [
            "カウンターには娘がいる。",
            "カインが話しかけようとすると、娘は嬉しそうに微笑んだ。",
            "カイン「店主に、油を取ってきてくれと頼まれた」",
            "娘「修理を手伝ってくださってありがとうございます。何が必要ですか？」"
        ],
        innRepairDaughterOilsOutro: [
            "カイン「……ええと」",
            "カインはオーエンをちらっと見た。",
            "オーエン「なあに」",
            "カイン（なんだったかな）",
            "娘「お父さんなら、テカテカ油ですね。親切なカインさんには、全部差し上げますね」",
            "《テカテカ油》を手に入れた！",
            "《ピカピカ油》を手に入れた！",
            "《カチカチ油》を手に入れた！",
            "カイン「えっ」",
            ...
            "カインはなんとか油の瓶を整理した。",
            "背後から、オーエンが甘く囁いた。",
            "オーエン「おまえをテカテカの……ピカピカにして、焼き殺したいっていう意味だよ」",
            "カイン（さすがに違うと思いたい）"
        ],
        innRepairFinish: [
            "カインは板材に《テカテカ油》を塗った。",
            ...
            "《テカテカ油》を使い切った。",
            "店主「よし。これで打ちつけられる」",
            "カインは板材を持ち上げ、外壁の穴へ押し当てた。",
            "店主は工具箱を開き、中を見て首を傾げた。",
            "店主「……釘がない。どこか別のところにしまったかな」",
            "カイン（次は釘を探しにいくのか）",
            "オーエン「ねえ」",
            "カイン「なんだ」",
            "オーエン「まさか今度は、釘を探しに行くんじゃないよね」",
            "カイン「心を読むなよ」",
            "オーエンは呆れたようにため息をついた。",
            "オーエン「釘ならあったよ。物置に」",
            "店主「本当か！」",
            "店主は物置へ釘を取りに行った。",
            "カイン「……本当か？」",
            "オーエン「なんでおまえが知らないんだよ。あんなに毎晩寝てたのに」",
            "カイン「寝てたからな」",
            "しばらくすると、店主は釘を持って戻ってきた。",
            "釘を手に入れた！（店主が）",
            "オーエン「ほらほら、早くして。もう甘いものがあるところに行こうよ」",
            "カインはオーエンに急かされながら、宿屋の修理を手伝った。",
            "外壁の穴が塞がった！",
            "カイン「これで安心だな」",
            "店主「ありがとな。晩飯も食ってけ」",
            "カイン「やった！　いっぱい食べていいか？」",
        ...
        // One-time picnic date, triggered from a stay once secretLetter is held and
        // herbGardenHandholdAttempted is true. See innSystem.playPhase7SimpleStay.
        picnicDateForest: [
            "ーーー",
            "カインと娘（とオーエン）は森の中でお弁当を広げていた。",
            "カイン（なんか、変な感じだな。ここでこうやってくつろぐのは）",
            "森の禍々しい気配はだいぶ薄らぎ、陽の光が差し込んだところには琥珀がキラキラ光っている。",
            "娘「あるもので作ったものですが、どうぞ」",
            "カイン「すごいな！うまそうだ」",
            "娘の手作り弁当はとても手間がかかっていて、見た目も美しい。",
            "カイン「こんな食事久しぶりだ」",
            "カインは本心からよろこんだ。",
            "カイン「悪いな。せっかくのデートなのに、こいつまで一緒で」",
            "娘「え！で、デートなんて、その、私……」",
            "娘はうつむいて赤くなった。",
            "オーエン「…ふうん。これ、デートなんだ」",
            "オーエンはそれを見て、にや、と笑った。",
            ...
            "カイン「おい！」",
            "娘の顔が曇った。",
            "娘「…もしかして、お相手はあの綺麗な占い師の方ですか？」",
            "カイン「いや、彼女は友達でそういうんじゃ」",
            "オーエン「あの女のデートは断ってたよ。カイン」",
            "娘「そうなんですね。今日はありがとうございます…！」",
            "オーエン「デートは、僕とした。ねえ、カイン」",
            "娘「え」",
            "オーエン「手も繋いで…むぐ」",
            "カイン「…っあはは」",
            "カインはオーエンの口にサンドイッチを押し込んだ。",
            "カイン「そうなんだ！と言いたいところだが、こいつはふざけるのが好きなんだ。間に受けるなよ」",
            "オーエンは眉間に皺を寄せてレタスを噛んだ。苦い、と言いたそうな顔だ。",
            "娘は納得してなさそうな様子だ。",
            "カイン（…そりゃあそうだ。デートに結局こいつを連れてきている）",
            "カイン「…っむぐっ！？」",
            "オーエンは自分の口に押し込まれかけてたサンドイッチを、カインの口に返した。",
            "オーエン「お返し」",
            "カイン「…っ！うまいサンドイッチだな！前から思ってたが、あんた、料理上手だ」",
            "カインは娘の顔を見てとびきりの笑顔で誤魔化した。",
            "娘「………」",
            "娘「…っぷっ！面白い方ですね！カインさんも、オーエンさんも！」",
            "カイン（奇跡的に誤魔化せた）",
            "（キスのくだりまで話されなくて本当によかった…）",
            "カインはオーエンの顔を見た。オーエンは楽しそうに微笑んでいる。",
            "娘「お二人は長いお付き合いなんですか？」",
            "カイン「そうでもない。あんたと同じくらいだ」",
            "娘「え？」",
            "カイン「ここに来る、ちょっと前に知り合ってさ」",
            "娘は目を丸くした。",
            "娘「そうなんですね。仲良さそうだから、てっきり…」",
            "カイン「良さそうか？」",
            "オーエン「仲、良さそうだって」",
            "娘「なにか同じ趣味のお友達なんですか？行き先が同じとか」",
            "カイン「行き先は…確かに同じかもな」",
            "（一蓮托生という言葉が浮かんだ）"
        ],
        picnicDateInnFront: [
            ...
            "オーエン「たのしかった？デート」",
            "カイン「……」",
            "カイン（二人きりじゃないのは、デートではない気がする）",
            "オーエン「僕が邪魔だった？」",
            "オーエンの言葉にドキッとする。",
            "図星だからではない。オーエンの、落ち着いたその声色が聞き慣れなかったから。",
            "カイン（こんなことを言うのか…。本当に全然こいつのことを理解できてない）",
            "カイン「そんなことはない」",
            "オーエン「本当に？」",
            "カイン「おまえのそばにいることが今一番重要なことだ。」",
            "迷いなくそう答えた。それは本心だった。",
            "オーエン「………」",
            "オーエンはチラッと剣を見て、何か言いたげな顔をした。",
            "だが何も言わなかった。"
        ],
        forestHutLocked: [
            "古い小屋がある。",
        ...
        forestHutSnakeEvent: [
            "中に入った途端、上から蛇が落ちてきた。",
            "カイン「……っ！」",
            "カインはとっさに後ずさり、オーエンの腕の中へ入った。",
            "オーエンの腕が、そのままカインの腹へ回る。",
            "オーエン「あんなのが怖いの？」",
            "カイン「驚いただけだ。怖いわけじゃない」",
            "オーエン「ふうん」",
            "オーエンが、カインの首元へ顔を寄せた。",
            "鼻先が肌に触れる。",
            "恐怖で敏感になっていた首筋が、ぴくりと反応した。",
            "オーエン「怯えてる匂い」",
            "カイン「……嗅ぐな」",
            "カイン（まだ心臓がバクバク言ってる…）",
            "もう調べる気にならないな。"
